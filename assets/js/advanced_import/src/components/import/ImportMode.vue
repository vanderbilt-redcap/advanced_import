    ...
    <div>
        <div class="my-2">
            ...
            <div class="form-check">
                <input class="form-check-input" disabled type="radio" name="import_mode" id="append" value="append" v-model="import_mode">
                <label class="form-check-label" for="append"><strong>Append:</strong> add new records</label>
            </div>
            <div class="form-check">
                <input class="form-check-input" disabled type="radio" name="import_mode" id="update" value="update" v-model="import_mode">
            ...
            <div class="form-check">
                <input class="form-check-input" disabled type="radio" name="import_mode" id="delete" value="delete" v-model="import_mode">
                <label class="form-check-label" for="delete"><strong>Delete:</strong> delete matching records</label>
            </div>
            <div class="form-check">
                <input class="form-check-input" disabled type="radio" name="import_mode" id="copy" value="copy" v-model="import_mode">
